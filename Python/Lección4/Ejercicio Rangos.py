...
rango = range(2,7) # que recorra desde posición 2 hasta la 7
for i in rango:
    print(i)

# Ejercicio 3: Crear un rango de 3 a 10 pero incrementar de 2 en 2, en lugar de 1 en 1.
# Ejemplo de ejecución: 3,5,7,9
print('Rango con valores de inicio = 3, fin = 10, incremento = 2')
for i in range(3,11, 2): # desde el 3, hasta el 11, de 2 en 2
    print(i)
