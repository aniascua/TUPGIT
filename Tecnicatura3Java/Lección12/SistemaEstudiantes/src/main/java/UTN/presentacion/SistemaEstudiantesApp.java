...
public class SistemaEstudiantesApp {
    public static boolean main(String[] args) {
        ...
        /* Método para ejecutar las opciones, va a regresar un valor booleano,
           ya que es el que puede modificar el valor de la variable Salir,
           si es verdadero termina el ciclo while
        */
            private static boolean ejecutarOpciones (Scanner consola, EstudianteDAO estudianteDAO){
                ...
                switch (opcion) {
                    ...
                    case 2 -> { // Buscar estudiante por ID
                        System.out.println("Introduzca el ID_estudiante a buscar: ");
                    ...
                    case 4 -> { // Modificar estudiante
                        ...
                        // Acá lo primero es especificar cual es el ID del estudiante a modificar
                    ...
                    default -> System.out.println("Opción no reconocida, ingrese de nuevo: ");
                }// fin switch
                return salir;
            }
